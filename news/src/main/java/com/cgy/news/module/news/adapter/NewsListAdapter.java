...
import com.cgy.news.module.news.provider.CenterPicNewsItemProvider;
import com.cgy.news.module.news.provider.RightPicNewsItemProvider;
import com.cgy.news.module.news.provider.TextNewsItemProvider;
import com.cgy.news.module.news.provider.ThreePicNewsItemProvider;
...
public class NewsListAdapter extends MultipleItemRvAdapter<News, BaseViewHolder> {
    ...
    public NewsListAdapter(String channelCode, List<News> data) {
        super(data);
