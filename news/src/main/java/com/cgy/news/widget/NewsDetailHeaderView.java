...
import com.cgy.news.relation.ShowPicRelation;
import com.cgy.news.utils.DateUtils;
...
public class NewsDetailHeaderView extends FrameLayout {
    ...
    private static final String NICK = "cgy";
    ...
    public void setDetail(NewsDetail detail, LoadWebListener listener) {
        ...
        mWvContent.getSettings().setJavaScriptEnabled(true);//设置支持JS
