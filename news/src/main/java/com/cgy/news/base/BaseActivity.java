...
import com.cgy.news.MainActivity;
...
public abstract class BaseActivity<T extends BasePresenter> extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (enableSlideClose()) {
            ...
            layout.setEdgeMode(ParallaxBackLayout.EDGE_MODE_DEFAULT);//边缘滑动
     ...
     * @return
     */
    private int getSlideLayoutType() {
        return LAYOUT_COVER;
    }
    ...
    public void onBackPressed() {
        if (mCurrentActivity instanceof MainActivity) {
            //如果是主页面
            if (System.currentTimeMillis() - mPreTime > 2000) {//再次点击间隔大于2秒
